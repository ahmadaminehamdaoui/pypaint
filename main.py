...
pen_tool = pygame.transform.scale(pygame.image.load('images/pen.png'), default_image_size)
eyedropper_tool = pygame.transform.scale(pygame.image.load('images/eyedropper.png'), default_image_size)
eraser_tool = pygame.transform.scale(pygame.image.load('images/eraser.png'), default_image_size)
fill_tool = pygame.transform.scale(pygame.image.load('images/fill.png'), default_image_size)
...
while True:
    ...
    screen.blit(pygame.transform.scale(pygame.image.load('images/'+pen.tool+'.png'), (22, 22)), (10, 579))
